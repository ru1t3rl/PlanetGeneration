Shader "Custom/AtmospherePostFX_WithBake"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            sampler2D _MainTex, _CameraDepthTexture, _BlueNoise, _BakedOpticalDepth;
            float4 _MainTex_ST;
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                if(dstThroughAtmosphere > 0) {
                    ...
                    float3 light = calculateLight(pointInAtmosphere, rayDir, dstThroughAtmosphere - epsilon * 2, col, i.uv);
                    
                    if(useExposure == 1) {
                        return 1 - exp(-intensity * float4(light, intensity));
